...
const FAQS = [
  ...
  },
  {
    ...
    answer: "Once your deals are verified, your Nordstrom voucher code will be delivered to your email within 24\u201348 hours."
  }
];
...
export default function App() {
  return (
    <>
      ...
      {/* Top Banner */}
      <div className="w-full bg-black text-white text-center py-2 text-[11px] font-bold tracking-widest uppercase">
      ...
      <main className="flex-1 flex flex-col items-center w-full max-w-[400px] mx-auto px-4 pt-6 pb-8">
        ...
        {/* Logo */}
        <div className="h-[48px] mb-5 mt-1 flex justify-center items-center w-full">
          <img
        ...
        <p className="text-gray-600 text-center mb-6 text-[13px]">
          Claim your <span className="font-bold text-black">$750</span> Nordstrom voucher
        </p>
        ...
        {/* CTA */}
        <button 
           onClick={() => window.location.href = 'https://giftclick.org/aff_c?offer_id=1325&aff_id=144760'}
